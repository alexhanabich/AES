...
# why implement this useless helper function when you can just XOR?
def ff_add(a, b):
    return a ^ b
...
def hex_print_list(lst):
    print([hex(i) for i in lst])


def hex_print_matrix(matrix):
    print([hex(x) for i in matrix for x in i])
